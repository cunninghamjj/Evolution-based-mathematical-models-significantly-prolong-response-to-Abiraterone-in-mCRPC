function [yS, yR, PSA, integerTime_u, t_NewAdaptive] = solveSRODE_IAT(optimizationParams, t_max, t_firstAbi, adaptivePercent)
...
integerTime_u(1:1750) = 0;
inductionOffTime = inf;

%% Here I am using three times the absolute maximum time reached during the trial. 
for i = 1:1:1750
    
    % Give induction period
    if i == t_firstAbi
        PSAmax = PSA(i);
        PSAmaxFoundFlag = 1;
        
        integerTime_u(i:i+243) = 1;
        
        inductionOffTime = i + 243;
    end
